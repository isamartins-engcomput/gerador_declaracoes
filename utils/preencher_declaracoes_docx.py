...
def preencher_declaracoes_docx(TITULO_ATIVIDADE,NOME_ESTUDANTE,CPF,RESUMO_ATIVIDADE,DATA_INICIAL,DATA_FINAL,CARGA_HORARIA,DATA_EMISSAO,NOME_RESPONSAVEL):
    ...
    for paragrafo in doc.paragraphs:
        for run in paragrafo.runs:
            run.text = run.text.replace("{{TITULO_ATIVIDADE}}",TITULO_ATIVIDADE)
